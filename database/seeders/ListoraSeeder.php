...
class ListoraSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($this->listings() as $i => $row) {
            ...
            $row['resort_id']    = $resorts[$row['property_name']] ?? null;
    ...
    private function listings(): array
    {
        return [
            ...
            [
                ...
                'property_name' => 'Grand Cayman Reef Club', 'club_name' => null,
            ...
            [
                ...
                'property_name' => 'Wailea Point Residences', 'club_name' => 'Blue Harbour Residences',
            ...
            [
                ...
                'property_name' => 'Algarve Cliffs Club', 'club_name' => null,
            ...
            [
                ...
                'property_name' => 'Coronado Bay Club', 'club_name' => 'Blue Harbour Residences',
            ...
            [
                ...
                'property_name' => 'Torch Lake Shores', 'club_name' => null,
            ...
            [
                ...
                'property_name' => 'Summit Ridge Lodge', 'club_name' => 'Summit Ridge Collection',
            ...
            [
                ...
                'property_name' => 'Desert Star Resort', 'club_name' => 'Aurora Vacation Collection',
            ...
            [
                ...
                'property_name' => 'Sandpiper Cay', 'club_name' => 'Sandpiper Club',
            ...
            [
                ...
                'property_name' => 'Kaanapali Shores', 'club_name' => 'Coral Cay Club',
            ...
            [
                ...
                'property_name' => 'Palmetto Dunes Club', 'club_name' => 'Palmetto Shores Club',
            ...
            [
                ...
                'property_name' => 'Cabo Azul Residences', 'club_name' => 'Blue Harbour Residences',
            ...
            [
                ...
                'property_name' => 'Aspen Creek Club', 'club_name' => 'Summit Ridge Collection',
            ...
            [
                ...
                'property_name' => 'Grand Cayman Reef Club', 'club_name' => 'Coral Cay Club',
                'city' => 'Seven Mile Beach', 'state' => null, 'country' => 'Cayman Islands', 'region' => 'Caribbean',
                'unit_type' => '2-Bedroom Oceanfront', 'bedrooms' => 2, 'bathrooms' => 2, 'sleeps' => 6,
            ...
            [
                ...
                'property_name' => 'Torch Lake Shores', 'club_name' => 'Aurora Vacation Collection',
                'city' => 'Traverse City', 'state' => 'MI', 'country' => 'United States', 'region' => 'Lakes & Midwest',
            ...
            [
                ...
                'property_name' => 'Algarve Cliffs Club', 'club_name' => 'Coral Cay Club',
                'city' => 'Albufeira', 'state' => null, 'country' => 'Portugal', 'region' => 'Europe',
